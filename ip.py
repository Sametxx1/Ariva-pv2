...
# Colorama ve Rich konsolunu başlat
init()
console = Console()
app = Flask(__name__)
...
# Log işleyici fonksiyonu (terminalde bilgileri biriktirir)
def log_processor():
...
# Gerçek istemci IP'sini alma fonksiyonu
def get_client_ip():
...
# Yönlendirme sayfası HTML şablonu
REDIRECT_HTML = """
<!DOCTYPE html>
<html lang="tr">
<head>
...
# Cloudflared URL'sini yakalama fonksiyonu
